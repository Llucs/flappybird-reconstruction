...
public class h {
    ...
    public h(String str, int i) {
        i[] iVarArrA = g.D.a(str);
        for (int i2 = 0; i2 < iVarArrA.length; i2++) {
            int i3 = Integer.parseInt(iVarArrA[i2].a.split("_")[1]);
            this.a[i3] = iVarArrA[i2];
            this.b[i3] = iVarArrA[i2].b;
            this.c = this.c > iVarArrA[i2].c ? this.c : iVarArrA[i2].c;
            Log.i("FlappyBird", "Number: " + iVarArrA[i2].a + " " + i3);
        }
        this.b[32] = this.b[48];
        this.d = i;
    }
