    ...
    public void b(float f) {
        ...
        if (this.H) {
            ...
            if (!this.J.v && this.ak <= 0 && this.ao > 0) {
                ...
                if (a(this.J.b, this.J.c, this.J.e, this.J.f, this.ah, (this.ae - this.Z.c) - 96, this.Z.b, this.Z.c) || a(this.J.b, this.J.c, this.J.e, this.J.f, this.ah, this.ae, this.Y.b, this.Y.c)) {
                    c(1.0f);
                    a(4, 0.5f);
                    this.J.v = true;
                    this.ao = 0;
