...
public final class f {
    ...
    public static int a(Context context) {
        ...
        try {
            context.getResources().getString(com.google.android.gms.d.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
            Log.e("GooglePlayServicesUtil", "The Google Play services resources were not found. Check your project configuration to ensure that the resources are included.");
        }
        try {
            byte[] bArrA = a(packageManager.getPackageInfo("com.android.vending", 64), a);
            if (bArrA == null) {
    ...
    public static Dialog a(int i2, Activity activity, int i3, DialogInterface.OnCancelListener onCancelListener, int i4) {
        ...
        String strA = a(activity, i2);
        if (strA != null) {
            message.setPositiveButton(strA, cpVar);
        }
        switch (i2) {
        ...
        return message.setTitle(com.google.android.gms.d.common_google_play_services_unknown_issue).create();
    }
    ...
    public static String a(Context context, int i2) {
        ...
        switch (i2) {
            case com.google.android.gms.e.MapAttrs_cameraBearing /* 1 */:
                return resources.getString(com.google.android.gms.d.common_google_play_services_install_button);
            case com.google.android.gms.e.MapAttrs_cameraTargetLat /* 2 */:
                return resources.getString(com.google.android.gms.d.common_google_play_services_update_button);
            case com.google.android.gms.e.MapAttrs_cameraTargetLng /* 3 */:
                return resources.getString(com.google.android.gms.d.common_google_play_services_enable_button);
            default:
    ...
    public static String b(Context context, int i2, int i3) {
        ...
        switch (i2) {
            case com.google.android.gms.e.MapAttrs_cameraBearing /* 1 */:
                String string = a(context.getResources()) ? resources.getString(com.google.android.gms.d.common_google_play_services_install_text_tablet) : resources.getString(com.google.android.gms.d.common_google_play_services_install_text_phone);
                return a(i3) ? string + " (via Bazaar)" : string;
            case com.google.android.gms.e.MapAttrs_cameraTargetLat /* 2 */:
                String string2 = resources.getString(com.google.android.gms.d.common_google_play_services_update_text);
                return a(i3) ? string2 + " (via Bazaar)" : string2;
            case com.google.android.gms.e.MapAttrs_cameraTargetLng /* 3 */:
                return resources.getString(com.google.android.gms.d.common_google_play_services_enable_text);
            case com.google.android.gms.e.MapAttrs_cameraTilt /* 4 */:
            case com.google.android.gms.e.MapAttrs_uiCompass /* 6 */:
            case com.google.android.gms.e.MapAttrs_uiScrollGestures /* 8 */:
            default:
                return resources.getString(com.google.android.gms.d.common_google_play_services_unknown_issue);
            case com.google.android.gms.e.MapAttrs_cameraZoom /* 5 */:
                return resources.getString(com.google.android.gms.d.common_google_play_services_invalid_account_text);
            case com.google.android.gms.e.MapAttrs_uiRotateGestures /* 7 */:
                return resources.getString(com.google.android.gms.d.common_google_play_services_network_error_text);
            case com.google.android.gms.e.MapAttrs_uiTiltGestures /* 9 */:
                return resources.getString(com.google.android.gms.d.common_google_play_services_unsupported_text);
        }
    }
