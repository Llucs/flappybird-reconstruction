...
public class a {
    ...
    private static void a(Parcel parcel, int i, int i2) {
        int iA = a(parcel, i);
        if (iA != i2) {
            throw new b("Expected size " + i2 + " got " + iA + " (0x" + Integer.toHexString(iA) + ")", parcel);
        }
    }
    ...
    public static int b(Parcel parcel) {
        ...
        int iDataPosition = parcel.dataPosition();
        if (a(iA) != 20293) {
            throw new b("Expected object header. Got 0x" + Integer.toHexString(iA), parcel);
        }
        int i = iDataPosition + iA2;
        if (i < iDataPosition || i > parcel.dataSize()) {
            throw new b("Size read is invalid start=" + iDataPosition + " end=" + i, parcel);
        }
        return i;
    }
