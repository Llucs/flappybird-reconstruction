...
public final class AdUtil {
    ...
    public static String a(Context context) {
        if (c == null) {
            ...
            String strB = (string == null || c()) ? b("emulator") : b(string);
            if (strB == null) {
                return null;
            }
    ...
    public static String a(Map map) {
        try {
            ...
            g.d("JsonException in serialization: ", e2);
            return null;
        }
    }
        ...
        for (Object obj : set) {
            if ((obj instanceof String) || (obj instanceof Integer) || (obj instanceof Double) || (obj instanceof Long) || (obj instanceof Float)) {
                ...
                try {
                    ...
                    g.d("Unknown map type in json serialization: ", e3);
                }
            } else {
                g.e("Unknown value in json serialization: " + obj);
            }
        }
        return jSONArray;
    }
    ...
    public static boolean a(int i2, int i3, String str) {
        ...
        g.b("The android:configChanges value of the com.google.ads.AdActivity must include " + str + ".");
        return false;
    }
