...
public class e {
    ...
    public void a(int i, int i2, int i3, int i4, Bitmap bitmap, org.andengine.opengl.c.c cVar) {
        GLES20.glTexSubImage2D(i, i2, i3, i4, bitmap.getWidth(), bitmap.getHeight(), cVar.b(), cVar.c(), a.a(bitmap, cVar, ByteOrder.BIG_ENDIAN));
    }

    public void a(org.andengine.b.c.d dVar, org.andengine.opengl.view.a aVar, EGLConfig eGLConfig) {
